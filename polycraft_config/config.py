...
AGENT_COMMAND = "ant launch -Dmain=com.config.polycraft.PolycraftAgent -Dargs=\"-gameport 9000\""              # change using -x <windows cmd to launch script - Windows OS only>
AGENT_COMMAND_UNIX = "ant launch -Dmain=com.config.polycraft.PolycraftAgent -Dargs=\"-gameport 9000\""              # change using -x <windows cmd to launch script - Windows OS only>
